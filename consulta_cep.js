...
// função alert
function alertaSalvar(endereco) {
...
// verifica se o cep possui tamanho 8 só possui números
...
// associa a função limpar ao botão Limpar
const btn = document.getElementById("Limpar")
btn.addEventListener("click", limparFormulario)

//informa que o formulário foi salvo
const bt = document.getElementById("Salvar")
bt.addEventListener("click", alertaSalvar)